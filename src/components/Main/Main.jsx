...
const Main = () => {
  ...
  return (
    <div className="overflow-hidden main flex-1 z-50 min-h-screen pb-[15vh] relative">
      ...
      {/* Main Content */}
      <div
        className={`main-container max-w-[92vw] shadow-lg shadow-zinc-300 lg:max-w-[90vw] mx-5 h-[73vh] rounded-2xl ${
          !showResult ? "bg-slate-100" : "bg-gray-100"
                ...
                <div>
                  <div className="flex bg-purple-400 text-slate-100 py-4 px-3 gap-4 rounded-xl">
                    ...
                    <p
                      ...
                      className="text-[13px]  lg:text-[20px] w-[60vw] text-start leading-2 lg:pt-2 font-normal lg:leading-6"
                    ></p>
                  </div>
