...
const MainContent = ({ showResult, resultData, loading, showTime, recentPrompt, setHiddenDiv, HiddenDiv }) => {
  ...
  return (
    <Card
      className={`w-auto mx-4 h-[76vh] lg:h-[75vh] shadow-lg shadow-zinc-300  rounded-2xl ${!showResult ? "bg-slate-100" : "bg-gray-100"
      ...
      {showResult ? (
        ...
        <>
          <div className="text-4xl lg:text-6xl font-medium p-5">
            ...
            <p className="hidden md:block md:text-lg md:py-7 lg:block lg:text-xl text-center text-wrap pt-4 lg:px-20 font-normal text-[#7a7373]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto px-2 mb-4 lg:px-4 lg:mb-20 rounded-3xl">
